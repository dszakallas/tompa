...
fn limits_bound_rule(syntax: &Limits, rule: &LimitsBoundRule, _context: &Context) -> WrappedResult<()> {
...
fn table_type_rule(syntax: &TableType, rule: &TableTypeRule, context: &Context) -> WrappedResult<()> {
